...
export default function PrivacyPage() {
  return (
    <main id="main-content" className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-background mt-10 rounded-xl shadow-sm border border-slate-100 dark:border-border">
      <h1 className="text-3xl font-bricolage font-black text-slate-900 dark:text-foreground mb-6 tracking-tight">Privacy Policy</h1>
      ...
      <div className="prose dark:prose-invert text-slate-600 dark:text-muted-foreground">
        ...
        <h2 className="text-xl font-bold mt-8 mb-4 text-slate-800 dark:text-foreground">Data Sourcing and Personal Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-bold mt-8 mb-4 text-slate-800 dark:text-foreground">Information We Do Not Collect</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-bold mt-8 mb-4 text-slate-800 dark:text-foreground">Third-Party Links</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-bold mt-8 mb-4 text-slate-800 dark:text-foreground">Updates to This Policy</h2>
        <p className="mb-4">
